...
def populateChangeOwner() {
    ...
    switch(caPlatformValue?.toLowerCase()){
        ...
        case "hhs engineering": // added JIRA-10050
            caPlatformOwner?.setFormValue("danny.sanchez@teladochealth.com")
            caPlatformOwner?.setReadOnly(true)
        break;
        case "hhs platform ops": // added JIRA-10050
            caPlatformOwner?.setFormValue("KHanrahan@teladochealth.com")
            caPlatformOwner?.setReadOnly(true)
        break;
        ...
        case "hhs solution analysis and design":
            caPlatformOwner?.setFormValue("gbrallier@teladochealth.com")
            caPlatformOwner?.setReadOnly(true)
        break;
        default:
